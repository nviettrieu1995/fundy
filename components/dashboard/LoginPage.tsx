...
import { MOCK_USER_EMAIL, MOCK_USER_PASSWORD, MOCK_ADMIN_EMAIL, MOCK_ADMIN_PASSWORD, MOCK_WORKER_EMAIL, MOCK_WORKER_PASSWORD } from '../../constants';
...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (loggedInUser) {
      ...
      // No explicit navigate here, App.tsx will redirect.
    } else {
